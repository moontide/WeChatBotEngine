...
net_maclife_wechat_http_BotApp.logger.info ("\n" + sJSONString);
	...
	{
		return OnImageMessageReceived (sFrom_EncryptedRoomAccount, sFrom_RoomNickName, sFrom_EncryptedAccount, sFrom_NickName, sTo_EncryptedAccount, sTo_NickName, fMedia);
	}
}
