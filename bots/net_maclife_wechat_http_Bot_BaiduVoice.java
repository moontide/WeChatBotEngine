...
net_maclife_wechat_http_BotApp.logger.info  ("	" + sResponseBodyContent);
			...
			switch (err_no)
			{
				case 0:
					...
					//break;
				case 3300:
					SendTextMessage (sFrom_RoomAccountHash, sFrom_AccountHash, sFrom_NickName, "输入参数不正确");
					break;
				case 3301:
					SendTextMessage (sFrom_RoomAccountHash, sFrom_AccountHash, sFrom_NickName, "识别错误");
					break;
				case 3302:
					SendTextMessage (sFrom_RoomAccountHash, sFrom_AccountHash, sFrom_NickName, "验证失败");
					break;
				case 3303:
					SendTextMessage (sFrom_RoomAccountHash, sFrom_AccountHash, sFrom_NickName, "语音服务器后端问题");
					break;
				case 3304:
					SendTextMessage (sFrom_RoomAccountHash, sFrom_AccountHash, sFrom_NickName, "请求 GPS 过大，超过限额");
					break;
				case 3305:
					SendTextMessage (sFrom_RoomAccountHash, sFrom_AccountHash, sFrom_NickName, "产品线当前日请求数超过限额");
					break;
				default:
